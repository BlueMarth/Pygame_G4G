...
img_fb = pygame.image.load("visual/facebook_icon.png").convert()
display_img = img_fb
x, y = 0, 0
move_x, move_y = 0, 0
...
while True:
    ...
    if event.type == pygame.KEYDOWN:
        if event.key == pygame.K_RIGHT:
            ...
            display_img = pygame.image.load("visual/instagram_icon.png")
    ...
    if event.type == KEYUP:
        if event.key == pygame.K_RIGHT:
            ...
            display_img = pygame.image.load("visual/facebook_icon.png")
            pygame.display.update()
